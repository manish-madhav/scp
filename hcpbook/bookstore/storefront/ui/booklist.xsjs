...
var output = '<!DOCTYPE html><head><meta charset="UTF-8">' +
             '<title>SCP: The HANA XS Application Demo</title></head><body>' +
...
var pstmt = 
  conn.prepareStatement("SELECT * FROM \"_SYS_BIC\".\"p1942828411trial.hcpbook.bookstore.storefront.model::Bookstore.Books\"");
